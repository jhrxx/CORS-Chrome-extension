...
const lang = {
    ...
    pattern_placeholder: chrome.i18n.getMessage('pattern_placeholder'),
    desc_placeholder: chrome.i18n.getMessage('desc_placeholder'),
...
const eventHandler = () => {
    ...
    const initFilterList = () => {
        ...
        bgp.getConfig('urls', ({ urls }) => {
            ...
            const html = tmpl('white_list_template', { data, lang })
